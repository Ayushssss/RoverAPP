...
void setup() {
  ...
  */
  ...
  // beginSSL, not beginSslWithBundle: certificate validation needs a correct
  // clock, and on a network where NTP is blocked the handshake fails against
  // a 1970 date. Encrypted but unauthenticated — see the rover sketch for the
  // full reasoning.
